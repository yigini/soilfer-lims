...
@media (max-width: 600px) {
  ...
  /* Keep coach-top visibly reachable at all times on mobile */
  #soilfer-tutorial-overlay .coach-top {
    display: flex !important;
    flex-direction: column !important;
    padding: 10px 14px !important;
  }

  #soilfer-tutorial-overlay .coach-top .row {
    display: flex !important;
  ...
  #soilfer-tutorial-overlay .coach-foot .row {
    display: flex !important;
    align-items: center !important;
    gap: 8px !important;
  }
