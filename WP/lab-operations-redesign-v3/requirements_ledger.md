...
| A100 | Release | Production deployed commit/image recorded in release receipt | IN PROGRESS | Preparing release commit, PR, immutable Docker build, and production deployment receipt. |
