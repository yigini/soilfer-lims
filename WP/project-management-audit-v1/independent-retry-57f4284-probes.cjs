...
async function main(){
 ...
 const report={checkedAt:new Date().toISOString(),baseline:'57f428456fedf610bfc533e44791d87a05330fe0',sourceUnchanged:before===hash(),results};
 fs.writeFileSync(path.join(__dirname,'independent-retry-57f4284-results.json'),JSON.stringify(report,null,2));console.log(JSON.stringify(report,null,2));
}
