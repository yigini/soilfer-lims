...
async function main(){
 ...
 const report={checkedAt:new Date().toISOString(),baseline:'270a02d769ea8436777d6a94e8b9d94104761f4e',sourceUnchanged:before===hash(),results};fs.writeFileSync(path.join(__dirname,'monitor-intake-270a02d-results.json'),JSON.stringify(report,null,2));console.log(JSON.stringify(report,null,2));
}
