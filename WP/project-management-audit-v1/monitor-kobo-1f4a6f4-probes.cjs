...
async function main(){
 ...
 const report={checkedAt:new Date().toISOString(),baseline:'1f4a6f4a2f219eb745e241829279552624f8a21c',sourceUnchanged:before===hash(),externalCallsMocked:externalCalls,results};
 fs.writeFileSync(path.join(__dirname,'monitor-kobo-1f4a6f4-results.json'),JSON.stringify(report,null,2));console.log(JSON.stringify(report,null,2));
}
