...
const ManagerDashboard = ({ user }) => {
    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="card-base rounded-xl shadow-sm border p-5">
                    ...
                    {intakeQueue.length > 0 ? (
                        <div className="space-y-2">
                            {intakeQueue.slice(0, 6).map(s => (
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-3 rounded-lg bg-sf-surface border border-sf-divider hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-sm transition-all text-left group"
                                >
                        ...
                        <div className="text-center py-8 text-gray-400 text-sm border border-dashed rounded-lg bg-sf-canvas">
                        ...
                        <div className="space-y-2">
                            {reviewQueue.slice(0, 6).map(r => (
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-3 rounded-lg bg-sf-surface border border-sf-divider hover:border-amber-300 dark:hover:border-amber-700 hover:shadow-sm transition-all text-left group"
                                >
                                    <div className="min-w-0 flex-1">
                                        <div className="font-bold text-sm text-sf-text truncate">
            ...
            {oversight.length > 0 && (
                <div className="card-base rounded-xl shadow-sm border p-5">
                    <h3 className="text-lg font-black text-sf-text flex items-center gap-2 mb-4">
                    ...
                    <div className="space-y-3">
                        {oversight.slice(0, 10).map(s => (
                            <button
                                ...
                                className="w-full flex items-center gap-4 p-3 rounded-lg bg-sf-surface border border-sf-divider hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-sm transition-all text-left group"
                            >
                                <span className="font-mono font-bold text-sm text-sf-muted w-32 truncate shrink-0">{s.labId}</span>
                                <div className="flex-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xs font-black w-10 text-right text-sf-muted">{s.progress}%</span>
                                    </div>
                    ...
                    <div className="card-base rounded-xl shadow-sm border p-5">
                        ...
                        <div className="space-y-2">
                            {techWorkload.map(t => {
                                ...
                                return (
                                    <div key={t.username} className="flex items-center gap-3 p-3 rounded-lg bg-sf-surface border border-sf-divider">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="font-bold text-sm text-sf-text truncate">{t.name}</div>
                                        ...
                                        <div className="text-right shrink-0">
                                            <div className="text-lg font-black text-sf-muted">{t.assigned}</div>
