    ...
    return (
        <div className="flex flex-wrap items-center gap-3 text-xs font-medium">
            ...
            {isMultiLab && labs && labs.length > 0 ? (
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <select
                        ...
                        className="bg-transparent border-none text-gray-800 dark:text-gray-200 font-semibold focus:outline-none cursor-pointer pr-2"
                    >
                        <option value="">
            ...
            {/* Timezone Context */}
            {scope.timezone && (
                <div className="hidden sm:inline-flex items-center gap-1 text-gray-400 dark:text-gray-500 font-normal">
