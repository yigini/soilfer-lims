...
const MessagingCenter = ({ initialMessageId }) => {
        ...
        return (
            ...
            >
                <div className="flex justify-between items-start mb-1">
                    <span className="truncate text-sm text-gray-900 dark:text-gray-100 font-medium w-40 block">
                ...
                <div className="text-sm text-gray-800 dark:text-gray-200 mb-1 truncate">{msg.subject}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 line-clamp-1">{msg.body}</div>
            </div>
        );
    };
    ...
    const renderChatThread = () => {
        ...
        return (
            <div className="flex-1 flex flex-col overflow-hidden">
                {/* Thread Header */}
                <div className="px-4 py-3 border-b dark:border-gray-700 flex items-center gap-3 bg-white dark:bg-gray-800">
                    <button
                    ...
                    <div>
                        <p className="font-semibold text-sm text-gray-900 dark:text-white">{getPartnerName()}</p>
                ...
                {/* Messages */}
                <div className="flex-1 overflow-y-auto px-4 py-4 bg-gray-50 dark:bg-gray-900/40" style={{
                ...
                {/* Input Bar */}
                <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 relative">
                    {showEmojiPicker && (
                        <div
                            ref={emojiPickerRef}
                            className="absolute bottom-full left-4 mb-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl p-2 z-50 grid grid-cols-6 gap-1 animate-in zoom-in-95"
                        >
                            {['😊', '😂', '👍', '🙏', '🔥', '❤️', '✅', '🚀', '🤔', '👀', '✨', '👋', '🎉', '🤝', '🙌', '💯', '📍', '🧪'].map(emoji => (
                                <button
                                    key={emoji}
                    ...
                    <form onSubmit={handleChatSend} className="flex items-end gap-3">
                        ...
                        <div className="flex-1">
                            <textarea
                                className="w-full rounded-2xl border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm px-4 py-2.5 resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent max-h-24"
                                value={chatInput}
    ...
    // ── Main Render ───────────────────────────────────────────────
    return (
        <div className="flex h-[600px] border dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-800 shadow-sm">
            {/* Sidebar */}
            <div className="w-48 md:w-64 bg-gray-50 dark:bg-gray-900/50 border-r dark:border-gray-700 flex flex-col">
                <div className="p-4">
                    <button
                ...
                <nav className="flex-1 space-y-1 p-2">
                    ...
                    <button
                        ...
                        className={clsx("w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors", activeFolder === 'CHATS' ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800")}
                    >
                    ...
                    <button
                        ...
                        className={clsx("w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors", activeFolder === 'INBOX' ? "bg-white dark:bg-gray-800 text-blue-600 shadow-sm" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800")}
                    >
                        <div className="flex items-center gap-3"><Inbox size={18} /> Inbox</div>
                    </button>
                    <button
                        onClick={() => switchFolder('SENT')}
                        className={clsx("w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors", activeFolder === 'SENT' ? "bg-white dark:bg-gray-800 text-blue-600 shadow-sm" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800")}
                    >
                        <Send size={18} /> Sent
                    </button>
                    <button
                        onClick={() => switchFolder('DRAFT')}
                        className={clsx("w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors", activeFolder === 'DRAFT' ? "bg-white dark:bg-gray-800 text-blue-600 shadow-sm" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800")}
                    >
                        <FileText size={18} /> Drafts
                    </button>
                    <button
                        onClick={() => switchFolder('ARCHIVE')}
                        className={clsx("w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors", activeFolder === 'ARCHIVE' ? "bg-white dark:bg-gray-800 text-blue-600 shadow-sm" : "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800")}
                    >
                    ...
                    <div className="pt-4 mt-4 border-t dark:border-gray-700">
                        <button
                            ...
                            className={clsx("w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors", activeFolder === 'TRASH' ? "bg-white dark:bg-gray-800 text-red-600 shadow-sm" : "text-gray-500 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/10 hover:text-red-600")}
                        >
            ...
            {isChatTab ? (
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className={clsx(
                        "w-64 md:w-80 border-r dark:border-gray-700 flex flex-col bg-white dark:bg-gray-800",
                ...
                <>
                    ...
                    {/* Message List */}
                    <div className="w-64 md:w-80 border-r dark:border-gray-700 flex flex-col bg-white dark:bg-gray-800">
                        <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center">
                            <h3 className="font-semibold text-gray-900 dark:text-white capitalize">{activeFolder.toLowerCase()}</h3>
                    ...
                    <div className="flex-1 flex flex-col bg-gray-50/50 dark:bg-gray-900/20">
                        {isComposing ? (
                            <div className="flex-1 flex flex-col p-6 overflow-y-auto animate-in fade-in duration-200">
                                ...
                                <form onSubmit={onSend} className="space-y-4 flex-1 flex flex-col">
                                    <div>
                                        ...
                                        <select
                                            className="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white p-2.5"
                                    ...
                                    <div className="flex-1 flex flex-col">
                                        ...
                                        <textarea
                                            className="flex-1 w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white p-3 resize-none focus:ring-2 focus:ring-blue-500"
                                    ...
                                    <div className="flex justify-end gap-3 pt-2">
                                        {activeFolder !== 'CHATS' && (
                                            <button type="button" onClick={onSaveDraft} className="px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg flex items-center gap-2">
                            ...
                            <div className="flex-1 flex flex-col p-6 overflow-y-auto animate-in fade-in duration-200">
                                ...
                                <div className="whitespace-pre-wrap text-gray-800 dark:text-gray-200 leading-relaxed font-sans">
