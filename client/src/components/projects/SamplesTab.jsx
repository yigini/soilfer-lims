        ...
        <div className="space-y-4">
                ...
                <div>
                    ...
                    <p className="text-xs text-sf-muted mt-0.5">
                        {capabilities.isScopedOnly
                            ? t('projects.samples.scopedCount', 'Only samples in your authorized lab scope · {{count}} matching samples', { count: filteredSamples.length })
                            : t('projects.samples.wholeCount', 'Authorized project samples · {{count}} matching samples', { count: filteredSamples.length })}
                    </p>
                </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 p-3 rounded-xl bg-sf-surface border border-sf-divider">
                <div className="flex items-center gap-2">
                    ...
                    >
                        <option value="all">{t('projects.samples.allStages', 'All stages ({{count}})', { count: samples.length })}</option>
            ...
            <div className="card-base rounded-2xl shadow-sm border border-sf-divider bg-sf-surface overflow-hidden">
                ...
                {filteredSamples.length > 100 && (
                    <div className="p-3 text-center text-xs text-sf-muted border-t border-sf-divider bg-sf-inset">
                        {t('projects.samples.showingFirst100', 'Showing first 100 matching samples. Use search or the full sample list for more.')}
                    </div>
                )}
            </div>
