...
import { buildNavItems } from './navigationConfig';
...
const Layout = ({ children }) => {
    ...
    const navItems = buildNavItems(user, t, {
        LayoutDashboard, Package, TestTube2, ClipboardList, Beaker, ShieldAlert,
        FileText, Activity, Monitor, FileSpreadsheet, Table, User, Settings, Info
    });
