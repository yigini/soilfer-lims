/**
 * Client-Side Universal Coordinate & Geodesy Parser
...
export function utmToLatLng(zone, hemisphere, easting, northing) {
...
export function parseDmsPart(part) {
...
export function estimateDdUncertainty(str) {
