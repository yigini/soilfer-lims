...
const SAMPLE_STATES = {
    ...
    RECEIVED_REJECTED: 'RECEIVED_REJECTED' // RC-19: Physically arrived but rejected at intake (non-conformance)
};

const SAMPLE_STATE_LIST = Object.values(SAMPLE_STATES);

const SAMPLE_TRANSITIONS = {
    [SAMPLE_STATES.EXPECTED]: [SAMPLE_STATES.RECEIVED, SAMPLE_STATES.ACCEPTED, SAMPLE_STATES.RECEIVED_REJECTED],
    [SAMPLE_STATES.RECEIVED]: [SAMPLE_STATES.ACCEPTED, SAMPLE_STATES.EXPECTED, SAMPLE_STATES.RECEIVED_REJECTED],
    [SAMPLE_STATES.ACCEPTED]: [SAMPLE_STATES.PROCESSING, SAMPLE_STATES.RECEIVED, SAMPLE_STATES.APPROVED, SAMPLE_STATES.RECEIVED_REJECTED],
    [SAMPLE_STATES.PROCESSING]: [SAMPLE_STATES.SUBMITTED_PARTIAL, SAMPLE_STATES.SUBMITTED_FULL, SAMPLE_STATES.APPROVED],
    [SAMPLE_STATES.SUBMITTED_PARTIAL]: [SAMPLE_STATES.PROCESSING, SAMPLE_STATES.APPROVED],
...
const WORK_ITEM_TRANSITIONS = {
    [WORK_ITEM_STATES.NOT_ASSIGNED]: [WORK_ITEM_STATES.ASSIGNED, WORK_ITEM_STATES.WAIVED],
    [WORK_ITEM_STATES.ASSIGNED]: [WORK_ITEM_STATES.IN_PROGRESS, WORK_ITEM_STATES.NOT_ASSIGNED],
    [WORK_ITEM_STATES.IN_PROGRESS]: [WORK_ITEM_STATES.COMPLETED, WORK_ITEM_STATES.ASSIGNED],
    ...
    [WORK_ITEM_STATES.REANALYSIS_REQUIRED]: [WORK_ITEM_STATES.ASSIGNED],
